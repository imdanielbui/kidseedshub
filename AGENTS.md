...
This project is indexed by GitNexus as **kidseedshub** (4354 symbols, 8274 relationships, 273 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
