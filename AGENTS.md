...
This project is indexed by GitNexus as **kidseedshub** (4312 symbols, 8131 relationships, 258 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
