...
This project is indexed by GitNexus as **kidseedshub** (3737 symbols, 7181 relationships, 235 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
