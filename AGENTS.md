...
This project is indexed by GitNexus as **kidseedshub** (4573 symbols, 8650 relationships, 264 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
