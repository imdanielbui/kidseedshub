...
This project is indexed by GitNexus as **kidseedshub** (4435 symbols, 8361 relationships, 266 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
