...
This project is indexed by GitNexus as **kidseedshub** (4351 symbols, 8251 relationships, 270 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
