...
This project is indexed by GitNexus as **kidseedshub** (4301 symbols, 8103 relationships, 259 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
