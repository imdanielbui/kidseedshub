...
This project is indexed by GitNexus as **kidseedshub** (4434 symbols, 8360 relationships, 266 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
