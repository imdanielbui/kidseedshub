...
This project is indexed by GitNexus as **kidseedshub** (4116 symbols, 7809 relationships, 250 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
