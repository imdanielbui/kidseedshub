...
This project is indexed by GitNexus as **kidseedshub** (4358 symbols, 8241 relationships, 263 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
