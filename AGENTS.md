...
This project is indexed by GitNexus as **kidseedshub** (3246 symbols, 6279 relationships, 223 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
