...
This project is indexed by GitNexus as **kidseedshub** (3284 symbols, 6337 relationships, 225 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
