...
This project is indexed by GitNexus as **kidseedshub** (4341 symbols, 8206 relationships, 263 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
