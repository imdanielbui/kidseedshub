...
This project is indexed by GitNexus as **kidseedshub** (4309 symbols, 8129 relationships, 259 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
