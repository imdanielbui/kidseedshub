...
This project is indexed by GitNexus as **kidseedshub** (4193 symbols, 7935 relationships, 255 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
