...
This project is indexed by GitNexus as **kidseedshub** (4510 symbols, 8499 relationships, 264 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
