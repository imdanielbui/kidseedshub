...
This project is indexed by GitNexus as **kidseedshub** (4391 symbols, 8297 relationships, 268 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
